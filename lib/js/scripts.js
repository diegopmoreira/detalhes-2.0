...
$(document).ready(function () {
  ...
  $(window).on('scroll', function () {
    ...
    if (navlink_off.top > 100 ) {
      //$(".nav-link").css("color", "white");
      $(".nav-link").css("background", "rgba(239, 208, 154, 0.8)");
      $(".navbar").css("background-color", "transparent");
      $(".navbar img").css("background-color", "rgba(239, 208, 154, 0.8)");
  ...
  $(".servicos-menu").click(function () {

    $('.first-page').slideUp(600, function () {
      $('.navbar').fadeIn(800);
      $('html, body').animate({ scrollTop: $(".extra-page").offset().top}, 1000);
